...
PROJECT_NAME=denys_datsko_thesis
...
'
  'Toppra' 'waitForControl; roslaunch toppra_trajectory_generation toppra_trajectory_generation.launch generation_config_file:=./custom_configs/toppra_trajectory_generation.yaml 
'  
